@echo off
rem
rem Runs boson-node from a directory holding bin\ and lib\: a Boson distribution, or target\dist.
rem
...
"%JAVA%" -XX:+UseSerialGC %JAVA_OPTS% -cp "%BASEDIR%\lib\*" io.bosonnetwork.node.cli.BosonNode %*
exit /b %ERRORLEVEL%
